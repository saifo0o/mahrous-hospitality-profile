      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        duration: 0.5
          ...
          <p className="text-luxury-gray mt-4 max-w-2xl mx-auto">
            {language.code === 'ar' ? "تحليلات مفصلة لمشاريع الضيافة التحويلية التي توضح نهجي الاستراتيجي في مواجهة تحديات إدارة الفنادق والنتائج القابلة للقياس." : "Detailed analyses of transformational hospitality projects that showcase my strategic approach to hotel management challenges and measurable results."}
          </p>
        </motion.div>

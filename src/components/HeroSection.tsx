...
const HeroSection = () => {
  return <section className="relative min-h-screen flex items-center luxury-gradient overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10 py-20 md:py-0">
        <div className="max-w-3xl animate-fade-in flex flex-col md:flex-row items-center gap-8">
          <Avatar className="w-32 h-32 border-4 border-luxury-gold shadow-xl">
            <AvatarImage alt="Islam Mahrous" src="/lovable-uploads/7bc85deb-b7d7-4833-92b4-af76f98a1c9c.jpg" className="object-cover" />

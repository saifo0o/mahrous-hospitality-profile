        ...
        <div className={`grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center ${isRTL ? 'direction-rtl' : ''}`}>
          ...
          >
            <div className="relative">
              ...
              {/* Floating stat card */}
              <motion.div
                className="absolute -bottom-5 -left-6 md:-left-12 bg-card/95 backdrop-blur-md rounded-xl shadow-xl border border-border/50 px-6 py-4"
                initial={{ opacity: 0, x: -30, y: 20 }}
                animate={{ opacity: 1, x: 0, y: 0 }}
                transition={{ delay: 1.2, duration: 0.7, ease: [0.16, 1, 0.3, 1] }}
              >
                <p className="text-3xl font-bold font-playfair gradient-text">$70M+</p>
                <p className="text-xs text-muted-foreground font-medium">{language.code === 'ar' ? 'ميزانيات مُدارة' : 'Budgets Managed'}</p>
              </motion.div>

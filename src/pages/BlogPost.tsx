        ...
        <div className="container mx-auto px-4 md:px-8 max-w-4xl">
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              {post.category && <Badge variant="secondary" className="rounded-full">{post.category}</Badge>}
            ...
            <h1 className="text-3xl md:text-5xl font-bold font-playfair text-foreground leading-tight mb-5">
              {post.title}
            </h1>

            <div className="flex flex-wrap items-center gap-4 text-sm text-muted-foreground pb-6 border-b border-border/60">
              <span className="font-medium text-foreground">By Islam Mahrous</span>
              ...
              <div className="flex items-center gap-2">
                {socialLinks.map((s) => (
                  <a
                    ...
                    className={`inline-flex items-center justify-center w-10 h-10 rounded-lg border border-border text-muted-foreground transition-all ${s.color}`}
                  >
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center w-10 h-10 rounded-lg border border-border text-muted-foreground hover:bg-muted transition-all"
                >

  ...
  const majorAwards = [
    {
      title: language.code === 'ar' 
        ? "جائزة المدير العام للشرق الأوسط وأفريقيا"
        : "Middle East & Africa General Manager Award",
      category: language.code === 'ar' ? "تميز العملاء" : "Customer Excellence",
      year: "2017",
      organization: language.code === 'ar' ? "ماريوت الدولية" : "Marriott International",
      description: language.code === 'ar'
        ? "تم التكريم للقيادة الاستثنائية في خدمة العملاء وتحقيق درجات رضا ضيوف متميزة عبر جميع مقاييس الخدمة."
    ...
    {
      title: language.code === 'ar' 
        ? "جائزة الأفضل في فئتها ستار فويس" 
        : "Best-in-Class Award Star Voice",
      category: language.code === 'ar' ? "للسنة الثانية على التوالي" : "2nd consecutive year",
      year: "2017",
      organization: language.code === 'ar' ? "ماريوت الدولية" : "Marriott International",
      description: language.code === 'ar'
        ? "تم منح الجائزة للحفاظ على تقييمات رضا الضيوف المتفوقة لسنتين متتاليتين، مما يدل على التميز المستمر في الخدمة والقيادة."
    ...
    {
      title: language.code === 'ar' 
        ? "أفضل مدير للابتكار التشغيلي" 
        : "Best Director of Operational Innovation",
      ...
      description: language.code === 'ar'
        ? "تم اختياره للمساهمات المتميزة في الابتكار التشغيلي، وتنفيذ تحسينات النظام التي تم تصديرها إلى عدة عقارات."
  ...
  const achievements = [
    {
      ...
      year: "2005",
      description: language.code === 'ar'
        ? "تم تعيينه لتدريب 5 عقارات في مصر والمغرب، وتصدير 4 أفضل ممارسات إلى قسم أوروبا وأفريقيا والشرق الأوسط."
    ...
    },
    {
      ...
      year: "2004-2006",
      description: language.code === 'ar'
        ? "قاد جهود سيكس سيجما في شيراتون ميرامار، متجاوزًا الميزانيات المالية وجميع معايير مصفوفة سيكس سيجما."
        : "Led Six Sigma efforts at Sheraton Miramar, exceeding financial budgets and all Six Sigma criteria matrices."
    },
    {
      title: language.code === 'ar' ? "أفضل نمو في هامش الأرباح قبل الفوائد والضرائب والإهلاك والاستهلاك في أوروبا والشرق الأوسط وأفريقيا" : "Best EBITDA Margin Growth in EMEA",
      year: "2003",
      description: language.code === 'ar'
        ? "عضو في فريق الإدارة الذي حقق 'أفضل نمو في هامش الأرباح قبل الفوائد والضرائد والإهلاك والاستهلاك' في قسم أوروبا والشرق الأوسط وأفريقيا."
        : "Member of management team that achieved \"Best EBITDA Margin Growth\" in Europe, Middle East, and Africa division."
    },
    {
      title: language.code === 'ar' ? "قيادة مشاريع سيكس سيجما" : "Six Sigma Projects Lead",
      year: "2002",
      description: language.code === 'ar'
    ...
    },
    {
      ...
      year: "2000",
      description: language.code === 'ar'
        ? "تم الاعتراف بالتميز في التدريب والتطوير في منتجع وكازينو هيلتون الغردقة."
        : "Recognized for excellence in training and development at Hurghada Intercontinental Resort & Casino."
    },
    {
      title: language.code === 'ar' ? "تميز قسم الغرف" : "Rooms Division Excellence",
      year: "2000",
      description: language.code === 'ar'
          ...
          <div className="container mx-auto px-4 md:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-luxury-gray mt-4 max-w-2xl mx-auto">
                {language.code === 'ar'
                  ? 'تم التكريم للتميز في قيادة الضيافة والابتكار وخدمة العملاء طوال مسيرة مهنية متميزة امتدت لثلاثة عقود.'
            ...
            <div className="mb-16">
              <h2 className="text-2xl font-bold mb-8 text-luxury-navy">
                {language.code === 'ar' ? 'الجوائز الرئيسية في الصناعة' : 'Major Industry Awards'}
              </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                  ...
                  <p className="text-sm text-luxury-gray">
                    {language.code === 'ar'
                      ? 'قاد مجلس مدراء عموم ماريوت مصر (2019-2022)، ونفذ مبادرات بين العقارات حسنت رضا الضيوف بنسبة 10٪ وزادت إيرادات الأغذية والمشروبات بنسبة 8٪.'
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                  <h3 className="font-semibold text-luxury-navy mb-3 flex items-center">
                    ...
                    {language.code === 'ar' ? 'تحويل العقارات' : 'Property Transformation'}
                  </h3>
                  <p className="text-sm text-luxury-gray">
                    {language.code === 'ar'
                      ? 'أدار عملية تجديد شاملة لفندق شيراتون المنتزه (2016-2023)، وحدّث جميع الأنظمة مع الحفاظ على نسبة إشغال 72٪.'
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                  ...
                  <p className="text-sm text-luxury-gray">
                    {language.code === 'ar'
                      ? 'نجح في إدارة عمليات ما قبل الافتتاح لعدة عقارات مرموقة، محققًا باستمرار 90٪+ من الجاهزية التشغيلية.'
